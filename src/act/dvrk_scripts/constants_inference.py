...
TASK_CONFIGS = {
    ...
    #     'episode_len': 400,
    #     'action_mode': ['SE3', 
    #                     # TODO: need to recompute norm params due to additional 100 demos
    #                     {'max_': np.array((0.02249346, 0.01468174, 0.01204684, # xyz
    #                             1.,         0.96771133, 0.78480245, 0.99494973, 1., 0.64597649, # 6D rot
    #                             1.42631945, # jaw angle
    #                             0.00902286, 0.0146046, 0.01161923, # xyz
    #                             1., 0.78157781, 0.57063617, 0.84367832, 1., 0.41773725, # 6D rot
    #                             1.1191443)), # jaw angle

    #                     'min_': np.array((-0.01432833, -0.01270947, -0.0134067, # xyz
    #                         0.06242679, -0.9445956,  -0.56176033, -0.83406075,  0.09584525, -0.58471956, # 6D rot
    #                         -0.349066, # jaw angle
    #                         -0.01298958, -0.00661382, -0.010282, # xyz
    #                         0.49979759, -0.83663513, -0.48127809, -0.79032534,  0.53624179, -0.64717511, # 6D rot
    #                         -0.349066)), # jaw angle

    #                     'mean': np.array((-1.06764205e-03,  6.20326126e-04,  1.37897123e-03,  9.85512613e-01,
    #                     2.97264104e-02,  2.49116221e-02, -2.47199369e-02,  9.85265917e-01,
    #                     -1.17138720e-02, -2.54606825e-01, -2.49447275e-04,  8.64777637e-04,
    #                     1.62874055e-03,  9.75248013e-01, -2.48838222e-02, -5.44477655e-02,
    #                     8.14443954e-03,  9.71808278e-01, -2.69679196e-02,  8.55047676e-02)),

    #                     'std': np.array((0.01,       0.01,       0.01,       0.04426152, 0.12652708, 0.0963974,
    #                     0.12775193, 0.04624662, 0.10021715, 0.27032861, 0.01,       0.01,
    #                     0.01,       0.05960361, 0.14901988, 0.13981429, 0.13711055, 0.06253015,
    #                     0.17912495, 0.38952326)) }],
    #     'norm_scheme': 'std',
    #     'save_frequency': 250,
    #     'camera_names': ['left', 'right', 'left_wrist', 'right_wrist'],
    # },
