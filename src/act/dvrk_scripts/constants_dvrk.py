...
\
    ...
    'exvivo_19':{
        ...
        'phantom': False,
        'num_episodes': 11798,
        'tissue_samples_ids': [4, 5, 6, 8, 12, 13, 14, 18, 19, 22, 23, 30, 32, 35, 39, 40, 41, 47, 49],
        'camera_file_suffixes':  ["_left.jpg", "_psm1.jpg", "_psm2.jpg"],
        'episode_len': 400, # not to be confused with number of demos
        'cutting_action_pad_size': 10,
        "recovery_ratio": 1.0,
        'action_mode': ['hybrid',
                        {'max_': np.array([0.039424246726751204, 0.0164110034911406, 0.02853797792824251, 0.9999999999999928, 0.9837317582676902, 0.5798955204543117, 0.8990514835829663, 0.9999999999999915, 0.824223148196973, 1.4579498842824292, 0.015869544352058902, 0.021253382003741397, 0.017716835525270896, 1.0, 0.7434911162485026, 0.4001076255102408, 0.9083624864319696, 0.9999999999999984, 0.4298430754910115, 1.397807299955499]), # jaw angle

                        'min_': np.array([-0.0290025623965316, -0.0240484740751371, -0.022949239522599592, 0.09309810816541564, -0.9525588096228303, -0.6879383578951446, -0.9442620946937176, 0.1506551215711407, -0.7418351347019987, -0.349096, -0.015731137245271903, -0.010359199487475799, -0.022559415870363093, 0.35555883709906433, -0.9151537749838216, -0.48467543379214684, -0.743349508565, 0.2753313281449586, -0.6485074010293244, -0.3490660000000002]), # jaw angle

                        'mean': np.array([0.000915221593418105, -7.377255822562051e-05, 0.00020182578169821228, 0.97529232927556, 0.016782447063751305, -0.022449762863053866, -0.01046969041539836, 0.9702481542141156, 0.041531440169310554, 0.5367361768778548, -0.00026164801555464157, 1.3503499205649263e-05, 0.00017775911838454773, 0.9987998693417853, -0.004422843678414824, -0.0007618534290935574, 0.0042837181953902575, 0.9987883922777228, -0.0016364501341300831, -0.3251466766326405]),

                        'std': np.array([0.01, 0.01, 0.01, 0.047525221977538036, 0.19797432528097492, 0.08103548539395701, 0.1909822651509076, 0.05231944648459306, 0.1325612848097593, 0.4919153858356854, 0.01, 0.01, 0.01, 0.01, 0.04149181170654782, 0.023723937689408177, 0.03982754013807114, 0.011107129656722428, 0.026289122884246466, 0.13293197719029218]) }],
    ...
    'exvivo_19_endoscope_relative':{
        ...
        'cutting_action_pad_size': 10,
        "recovery_ratio": 1.0,
        'action_mode': ['relative_endoscope',
                        {'max_': np.array([0.039424246726751204, 0.0164110034911406, 0.02853797792824251, 0.9999999999999928, 0.9837317582676902, 0.5798955204543117, 0.8990514835829663, 0.9999999999999915, 0.824223148196973, 1.4579498842824292, 0.015869544352058902, 0.021253382003741397, 0.017716835525270896, 1.0, 0.7434911162485026, 0.4001076255102408, 0.9083624864319696, 0.9999999999999984, 0.4298430754910115, 1.397807299955499]), # jaw angle
    ...
    'exvivo_20_ego':{
        ...
        'phantom': False,
        'num_episodes': 13006,
        'tissue_samples_ids': [5, 6, 8, 12, 13, 14, 18, 19, 22, 23, 30, 32, 35, 39, 40, 41, 47, 49, 50, 53],
        'camera_file_suffixes':  ["_left.jpg", "_psm1.jpg", "_psm2.jpg"],
        'episode_len': 400, # not to be confused with number of demos
        'cutting_action_pad_size': 10,
        "recovery_ratio": 1.0,
        'action_mode': ['ego',
                        {'max_': np.array([0.039424246726751204, 0.0164110034911406, 0.02853797792824251, 0.9999999999999928, 0.9837317582676902, 0.6393134532191455, 0.9150790552697087, 0.9999999999999915, 0.8512329514986485, 1.4579498842824292, 0.015869544352058902, 0.0225713790451713, 0.01747889628594121, 1.0, 0.6664039119069894, 0.4001076255102408, 0.7355135111352477, 0.9999999999999984, 0.4298430754910115, 1.397807299955499]), # jaw angle

                        'min_': np.array([-0.0290025623965316, -0.0240484740751371, -0.022949239522599592, 0.09309810816541564, -0.9525588096228303, -0.6879383578951446, -0.9442620946937176, 0.1506551215711407, -0.7418351347019987, -0.349096, -0.015731137245271903, -0.010359199487475799, -0.022559415870363093, 0.6060731935461392, -0.7790867730366554, -0.48467543379214684, -0.6672065397761106, 0.5830635199832587, -0.6485074010293244, -0.3490660000000002]), # jaw angle

                        'mean': np.array([0.0010746150634750014, -0.00011197367760326592, 0.0002114066870862865, 0.9740645805000719, 0.02250178284988723, -0.024679549478142982, -0.014338238805992057, 0.9685097741299374, 0.04825698439257234, 0.5380035075272428, -0.0002420951479502812, 2.354808939533732e-05, 0.00016641956537016812, 0.9989004551091325, -0.004233139686143567, -0.0007448119441848332, 0.004107530484189822, 0.9989039490188892, -0.0013228773179527213, -0.32577838836276896]),

                        'std': np.array([0.01, 0.01, 0.01, 0.0493520742899956, 0.20058383844713384, 0.08610040157196953, 0.19250543869032707, 0.05474776522013546, 0.13927969725439573, 0.49911418823936804, 0.01, 0.01, 0.01, 0.01, 0.039524678991785585, 0.02346001332200188, 0.03785193505610819, 0.01, 0.025522332203124463, 0.1319512061832715]) }],
